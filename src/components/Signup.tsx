...
const Signup = ({ isVisible }: Props) => {
    ...
    return (
        <div className={`${!isVisible && "tw-hidden"}  tw-fixed tw-top-0 tw-left-0 tw-bg-[rgb(0,0,0)] tw-bg-[rgba(0,0,0,0.4)] tw-w-full tw-h-full`}>
                    ...
                    <form className="tw-flex tw-flex-col tw-gap-5" onSubmit={handleSignup}>
                        <div className="tw-flex tw-flex-col tw-gap-2">
                            <div className="tw-flex tw-gap-2">
                                <Input type="text" placeholder="First name" className="tw-py-[8px] tw-px-[16px]"
                                    onChange={e => user.setFirstName(e.target.value)} />
                                <Input type="text" placeholder="Last name" className="tw-py-[8px] tw-px-[16px]" 
                                onChange={e => user.setLastName(e.target.value)} />
                            </div>
                            <Input type="email" placeholder="Email" className="tw-py-[8px] tw-px-[16px]" 
                            onChange={e => user.setEmail(e.target.value)} />
                            <Input type="password" placeholder="Password" className="tw-py-[8px] tw-px-[16px]" 
                            onChange={e => user.setPassword(e.target.value)} />
                            <Input type="password" placeholder="Confirm Password" className="tw-py-[8px] tw-px-[16px]" 
